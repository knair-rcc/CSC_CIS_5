...
int main(int argc, char** argv) {
    ...
    while (playAgn) {
        ...
        while (conGame) {
            ...
            char p2Rank1=card1.at(1);
            char p2Rank2=card2.at(1);
            char p2Rank3=card3.at(1);
            char p2Rank4=card4.at(1);
            char p2Rank5=card5.at(1);

            int result=0; //Set as Default: Tie between players
            if (p1Rank1>p2Rank1) {
                result=1; //Player 1 wins
            }
            else if (p1Rank1<p2Rank2) {
            ...
            */
                ...
                char wCard5=card1.at(1);
                char wCard6=card2.at(1);
                char wCard7=card3.at(1);
                char wCard8=card4.at(1);
        ...
        if (p1Cards==nCards||p2Cards==nCards) {
            bool conGame=false; //Game ends when one player has all the cards
            if (p1Cards==nCards) {
